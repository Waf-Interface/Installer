    ...
    try:
        ...
        steps = [
            ...
            (
                ...
                (update_frontend_config, "✓ Frontend config updated"),
            ),
...
def configure_apache(ip):
    ...
    <Directory {FRONTEND_DIR}>
        ...
        (
            ...
            ("sudo a2dissite 000-default.conf", "✓ Default site disabled"),
        ),
        ("Enabling WAF site", ("sudo a2ensite waf.conf", "✓ WAF site enabled")),
    ]
...
def finalize_installation(ip):
    ...
    console.print(
        f"⚙️  [bold]Backend API:[/] [cyan underline]https://{ip}:{BACKEND_PORT}[/]"
    )
    console.print(
